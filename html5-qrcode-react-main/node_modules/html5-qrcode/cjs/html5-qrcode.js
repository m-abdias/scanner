...
var Html5Qrcode = (function () {
    ...
    Html5Qrcode.prototype.pause = function () {
    ...
    Html5Qrcode.prototype.validateQrboxSize = function (internalConfig, rootElementWidth) {
        ...
        var validateAgainstRootElementSize = function (size) {
    ...
    Html5Qrcode.prototype.toQrdimensions = function (qrboxSize) {
        if (typeof qrboxSize === "number") {
