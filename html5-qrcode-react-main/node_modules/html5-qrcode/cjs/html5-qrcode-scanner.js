...
var Html5QrcodeScanner = (function () {
    ...
    Html5QrcodeScanner.prototype.createPermissionButton = function (scpCameraScanRegion, requestPermissionContainer) {
        ...
        requestPermissionButton.style.background = "#ec691b";
        requestPermissionButton.style.border = "0px";
        requestPermissionButton.style.color = "white";
        requestPermissionButton.style.borderRadius = "3px";
        requestPermissionButton.style.padding = "0.5rem";
        requestPermissionButton.style.paddingLeft = "1rem";
        requestPermissionButton.style.paddingRight = "1rem";
    ...
    Html5QrcodeScanner.prototype.renderCameraSelection = function (cameras) {
        ...
        cameraSelectionContainer.style.background = "#ec691b";
        cameraSelectionContainer.style.border = "0px";
        cameraSelectionContainer.style.color = "white";
        cameraSelectionContainer.style.borderRadius = "3px";
        cameraSelectionContainer.style.padding = "0.5rem";
        cameraSelectionContainer.style.paddingLeft = "1rem";
        cameraSelectionContainer.style.paddingRight = "1rem";
        ...
        cameraActionStartButton.style.background = "#ec691b";
        cameraActionStartButton.style.border = "0px";
        cameraActionStartButton.style.color = "white";
        cameraActionStartButton.style.borderRadius = "3px";
        cameraActionStartButton.style.padding = "0.5rem";
        cameraActionStartButton.style.paddingLeft = "1rem";
        cameraActionStartButton.style.paddingRight = "1rem";
        ...
        cameraActionStopButton.style.background = "#ec691b";
        cameraActionStopButton.style.border = "0px";
        cameraActionStopButton.style.color = "white";
        cameraActionStopButton.style.borderRadius = "3px";
        cameraActionStopButton.style.padding = "0.5rem";
        cameraActionStopButton.style.paddingLeft = "1rem";
        cameraActionStopButton.style.paddingRight = "1rem";
    ...
    Html5QrcodeScanner.prototype.createSectionSwap = function () {
        var $this = this;
        var TEXT_IF_CAMERA_SCAN_SELECTED = 'Selecione uma imagem';
        var TEXT_IF_FILE_SCAN_SELECTED = 'Scaneie uma imagem';
        var section = document.getElementById(this.getDashboardSectionId());
